      ...
      <main className="pt-20 px-4 max-w-md mx-auto space-y-6">
        ...
        <div className="space-y-4">
            <div className="flex gap-2 mb-4">
                <button onClick={() => setCalendarView('current')} className={`flex-1 py-3 rounded-xl font-bold transition-all ${calendarView === 'current' ? 'bg-lime-400 text-slate-900 shadow-lg' : 'bg-slate-800 text-slate-400'}`}>Mese Corrente</button>
                <button onClick={() => setCalendarView('next')} className={`flex-1 py-3 rounded-xl font-bold transition-all ${calendarView === 'next' ? 'bg-lime-400 text-slate-900 shadow-lg' : 'bg-slate-800 text-slate-400'}`}>Mese Prossimo</button>
            </div>
        ...
        {/* MATCH CONFERMATI SUMMARY + WHATSAPP / PLAYTOMIC */}
                       ...
                       <div className="flex flex-col gap-2">
                           ...
                           <div className="flex flex-col gap-1.5">
                                <button 
                                    ...
                                    className="flex items-center gap-1.5 text-[10px] text-green-400 font-black uppercase tracking-wider hover:text-green-300 transition-colors"
                                >
                                ...
                                <a 
                                    href="playtomic://" 
                                    className="flex items-center gap-1.5 text-[10px] text-blue-400 font-black uppercase tracking-wider hover:text-blue-300 transition-colors"
                                >
